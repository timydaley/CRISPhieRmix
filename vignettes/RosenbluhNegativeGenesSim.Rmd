...
length(which(Rosenbluh2017CRISPRi.sim.DESeq.log2fc.empiricalMix.fdr < 0.2))
sum(Rosenbluh2017CRISPRi.sim.essential$essential[which(Rosenbluh2017CRISPRi.sim.DESeq.log2fc.empiricalMix.fdr < 0.2)])
